...
export default function BookSelector() {
  ...
  const activeColor = books.find(b => b.id === (hoveredBook || selectedBook))?.color;
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        background: activeBg
          ? `radial-gradient(ellipse at 50% 0%, ${activeColor}33 0%, transparent 60%)`
            ...
            <div
              ...
              style={{
                background: hoveredBook === book.id
                  ? `linear-gradient(135deg, ${book.color}22, ${book.color}08)`
                ...
                opacity: selectedBook && selectedBook !== book.id ? 0.4 : 1,
              }}
            >
              {/* Emoji */}
